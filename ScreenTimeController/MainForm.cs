...
public class MainForm : Form
{
    ...
    public MainForm()
    {
        ...
        _appLockService = new AppLockService(_settingsManager, _timeTracker);
        _isLocked = false;
    ...
    private void ExitApplication()
    {
        ...
        try { _appLockService?.Stop(); } catch { }
        try { _appLockService?.Dispose(); } catch { }
    ...
    private void CleanupResources()
    {
        ...
        try { _timeTracker?.Dispose(); } catch { }
        try { _appLockService?.Stop(); _appLockService?.Dispose(); } catch { }
        try
        {
            if (_iconCache != null)
            {
