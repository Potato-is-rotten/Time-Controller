...
public class SettingsForm : Form
{
    ...
    private TabPage? _tabPageDailyLimits;
    private TabPage? _tabPageAppLimits;
    ...
    private void ApplyLanguage()
    {
        ...
        _tabPageDailyLimits!.Text = LanguageManager.GetString("DailyLimit");
        _tabPageAppLimits!.Text = LanguageManager.GetString("Applications");
    ...
    private void LoadSettings()
    {
        ...
        _appLimitSettingsControl!.SettingsManager = _settingsManager;
    }
    ...
    private void InitializeComponent()
    {
        ...
        int windowWidth = Math.Min(850, maxWidth);
        int windowHeight = Math.Min(750, maxHeight);
        ...
        _tabPageDailyLimits = new TabPage
        {
            Text = LanguageManager.GetString("DailyLimit"),
            BackColor = Color.FromArgb(240, 240, 240),
            Padding = new Padding(10)
        };

        _tabPageAppLimits = new TabPage
        {
            Text = LanguageManager.GetString("Applications"),
            BackColor = Color.FromArgb(240, 240, 240),
            Padding = new Padding(10)
        };
        ...
        _tabControl.Controls.Add(_tabPageDailyLimits);
        _tabControl.Controls.Add(_tabPageAppLimits);
